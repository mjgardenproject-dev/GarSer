...
interface ServiceDetailCardProps {
  ...
  className?: string;
  /** Encabezado de la tarjeta. Por defecto, el que ven las pantallas del jardinero. */
  title?: string;
  /**
   * Etiqueta de procedencia del dato. Al CLIENTE no se le dice "Declarado por el cliente"
   * -está hablando de sí mismo-, así que cada pantalla puede sustituirla o quitarla.
   */
      ...
      <div className="flex items-center justify-between mb-2 gap-2">
        ...
        {sourceLabel !== null && (
          <span className="inline-flex items-center gap-1 text-[11px] text-gray-500 shrink-0">
            ...
            {sourceLabel ?? (isManual ? 'Declarado por el cliente' : 'Analizado por IA (fotos)')}
          </span>
        )}
      </div>
