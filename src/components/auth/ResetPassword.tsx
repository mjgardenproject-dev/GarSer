      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-6">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-base sm:text-sm pr-10"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-emerald-700 text-white rounded-lg disabled:opacity-50"
          >
